          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Créer une Tache</h5>
              </div>
              <div class="card-body">
                <form action="NouvelleTache.do">
	...
	%>
                   ...
                   <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                       <label>Ordre:</label>
                        <input type="text" class="form-control" name="ordre" placeholder="Ordre" >
                      </div>
                    </div>
                  </div>
                   <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                       <label>Probleme:</label>
                        <input type="text" class="form-control" name="probleme" placeholder="Probleme">
                      </div>
                    </div>
                  </div>
                   <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                       <label>Description du probleme:</label>
                        <input type="text" class="form-control" name="dcrpt_prob" placeholder="Description du probleme" >
                      </div>
                    </div>
                  </div> 
                   ...
                   <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--blue" type="submit">Creer</button>
                        </div>
